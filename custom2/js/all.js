...
/* Last merge : Fri Feb 16 11:59:57 EET 2018  */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
/* Merging js: cooper_assign.js begins */
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */


var baseurl = "/custom2/cooper_assign.php?";
var sharedKeySaved = false;
$().ready(function() {
...
function findPartnerCallback(response)	{
	...
	if (respArray.length == 0) {
		...
		for(k=0;k<number_of_rows;k++){
			...
			table_body+='<tr>';
			table_body +='<td>';
			table_body +='<p id="' + key +'">' + respArray[k].shared_key + '<button title="Copy" onclick=\'copyToClipboard("#' + key + '")\'><i style="font-family:\'FontAwesome\'" class="fa-copy"></i></button></p>';
			table_body +='</td>';
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
/* Merging js: responseHTML.js begins */
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
...
function loadHTML(url, callback)
{
	...
	*/		
	...
	function processHTML(target)
	{
		//target.innerHTML = temp.innerHTML;
		alert("on Callbback function:");
	}

	function loadWholePage(url, callback)
	{
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
/* Merging js: sweetalert.min.js begins */
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
