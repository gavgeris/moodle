...
if (count($result4) > 0) {
    echo('<div class="alert alert-warning" style="text-align: justify;">
        <p>Οι ακόλουθες εργασίες χρειάζονται βαθμολόγηση</p>
    </div>');
    ...
    echo '<div class="alert alert-success" style="text-align:center;">Τέλεια! Δεν υπάρχουν εργασίες προς βαθμολόγηση.</div>';
}
